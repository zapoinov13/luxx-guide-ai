...
// Пространственный маршрут по хостелу. Выключен на проде: компонент готов,
// но подменяет обычную главную. Включить — раскомментировать импорт
// и вернуть обёртку <Walkthrough> вокруг <main> ниже.
                ...
                {RATINGS.slice(0, 4).map((r) => (
                  <li key={r.source}>
                    <span className="platform-score">
                      <span className="platform-name">{r.source}</span>
