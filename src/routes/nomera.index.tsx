...
export const Route = createFileRoute("/nomera/")({
  head: () => ({
    ...pageHead(
      ...
      `Сколько стоит хостел в Алматы посуточно: койко-место ${SITE.priceFrom.toLocaleString("ru-RU")} ₸ за ночь, одноместный номер от 10 000 ₸, двухместный 15 000 ₸. Что входит в цену, скидки на месяц.`,
      "/nomera",
    ),
    scripts: jsonLd(
    ...
    >
      ...
      <AnswerSection title="Что входит в стоимость?">
        <ul>
          ...
          <li>Интернет: Wi-Fi в общих зонах и комнатах, коворкинг и лаундж с телевизором.</li>
          <li>
      ...
      <AnswerSection title="Можно ли снять посуточно, на одну ночь?">
        <p>
          Да, минимальный срок — одни сутки, и цена за ночь одинаковая хоть на одну ночь, хоть на
          неделю. Предоплаты нет: место держат по сообщению в WhatsApp, деньги берут при заселении.
          Условия посуточной брони и ночного заезда — на странице{" "}
          <Link to="/hostel-posutochno-v-almaty">«Хостел в Алматы посуточно»</Link>.
        </p>
      </AnswerSection>
      ...
      <AnswerSection title="Сколько стоит проживание на месяц?">
        <p>
          ...
          машина и коворкинг включены, а до метро «Сайран» и автовокзала близко. Подробный расчёт —
          на странице <Link to="/hostel-na-mesyac">«Проживание на месяц»</Link>.
        </p>
      </AnswerSection>
