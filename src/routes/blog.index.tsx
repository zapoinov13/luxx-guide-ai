...
export const Route = createFileRoute("/blog/")({
  ...
  head: () => ({
    ...pageHead(
      "Блог Luxx Aparts: советы гостям Алматы",
      "Статьи для гостей Алматы от хостела Luxx Aparts: как добраться из аэропорта ночью, где остановиться недорого, хостел или квартира, что посмотреть за два дня.",
      "/blog",
    ),
...
function BlogIndexPage() {
  ...
  return (
    <ContentPage
      eyebrow="Блог"
      title="Блог Luxx Aparts: советы гостям Алматы"
