...
function FaqPage() {
  return (
    <ContentPage
      ...
      intro={`Ответы на вопросы, которые гости задают чаще всего: сколько стоит проживание, есть ли отдельные комнаты и кухня, как доехать от вокзала, можно ли с детьми. Не нашли свой вопрос — напишите в WhatsApp или позвоните ${SITE.phoneDisplay}, отвечаем круглосуточно.`}
