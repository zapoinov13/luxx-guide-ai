...
export const PAGE_DATES: Record<string, string> = {
  ...
  "/faq": "2026-09-11",
  "/kontakty": "2026-09-11",
  "/politika-konfidencialnosti": "2026-09-18",
  "/foto": "2026-09-11",
  "/blog": "2026-09-11",
...
export const ROOM_TYPES = [
  {
    ...
    description:
      "Капсульное койко-место со шторкой в мужской или женской комнате хостела Luxx Aparts в Алматы: 6 000 ₸. Шкафчик, розетка, бельё включено. Фото и что входит.",
    intro:
  ...
  },
  {
    ...
    description:
      "Двухместный номер Economy в Luxx Aparts: 15 000 ₸ за номер. Отдельная комната с двуспальной кроватью и окном для пары или семьи, санузел на этаже. Фото и цена.",
    intro:
