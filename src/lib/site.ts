 ...
 * HotelRoom + Offer. Цены (variants) прислал заказчик в сентябре 2026: за ночь,
...
export const ROOM_TYPES = [
  {
    ...
    title: "Койко-место в хостеле Luxx Aparts, Алматы — 6 000 ₸ за ночь",
    description:
      "Капсульное койко-место со шторкой в мужской или женской комнате хостела Luxx Aparts в Алматы: 6 000 ₸ за ночь. Шкафчик, розетка, бельё включено. Фото и что входит в цену.",
    intro:
      "Койко-место в Luxx Aparts стоит 6 000 ₸ за ночь на сентябрь 2026, одинаково в мужской и женской комнате. Это капсульная кровать со шторкой, розеткой и лампой в мужской или женской комнате на 10–14 мест. У каждого гостя запирающийся шкафчик, бельё включено, санузел с душевыми общий на этаже. Кухня, Wi-Fi и стиральная машина бесплатно.",
    details: [
      [
      ...
      [
        ...
        "Ночь стоит 6 000 ₸, неделя по этому тарифу — 42 000 ₸. Для проживания от недели и от месяца администратор считает индивидуально: напишите срок в WhatsApp, и в ответ придёт точная сумма. Прямое бронирование без комиссии агрегатора.",
      ],
    ] as QA[],
  },
  {
    ...
    description:
      "Одноместный номер Economy в Luxx Aparts: 10 000 ₸ за ночь без окна, 11 000 ₸ с окном. Отдельная комната на ключ, стол, санузел на этаже. Фото, что входит в цену.",
    intro:
      "Одноместный номер Economy в Luxx Aparts стоит 10 000 ₸ за ночь без окна и 11 000 ₸ с окном на сентябрь 2026. Это отдельная комната с односпальной кроватью и столом для работы, дверь закрывается на ключ. Санузел с душевыми общий на этаже. Кондиционер, отопление и Wi-Fi включены, бельё выдают при заселении.",
    details: [
      [
      ...
      [
        ...
        "10 000 ₸ за ночь без окна и 11 000 ₸ с окном (сентябрь 2026). Для срока от недели и от месяца цена считается индивидуально: напишите даты в WhatsApp или позвоните, ответ круглосуточно. Оплата при заселении наличными или картой.",
      ],
    ] as QA[],
  },
  {
    ...
    description:
      "Двухместный номер Economy в Luxx Aparts: 15 000 ₸ за ночь за номер. Отдельная комната с двуспальной кроватью и окном для пары или семьи, санузел на этаже. Фото, что включено.",
    intro:
      "Двухместный номер Economy в Luxx Aparts стоит 15 000 ₸ за ночь за номер на сентябрь 2026, то есть 7 500 ₸ с человека. Это отдельная комната с двуспальной кроватью и окном для пары, двух друзей или родителя с ребёнком. Дверь закрывается на ключ, санузел с душевыми общий на этаже. Кондиционер, отопление и Wi-Fi включены.",
    details: [
      [
      ...
      [
        ...
        "15 000 ₸ за ночь за номер целиком, независимо от того, живёт один гость или двое (сентябрь 2026). Для срока от недели и от месяца цена считается индивидуально: напишите даты в WhatsApp. Оплата при заселении наличными или картой.",
      ],
    ] as QA[],
  },
] as const;
