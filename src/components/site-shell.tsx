  ...
  return (
    <BookingContext.Provider
      value={(selection, trigger) => {
        bookingTrigger.current = open ? menuButton.current : trigger;
        setOpen(false);
        ...
        <header className="site-header sticky top-0 z-50 border-b border-border/70 bg-background/90 backdrop-blur">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-4 px-5 lg:px-8">
            ...
            <div className="hidden items-center gap-1 xl:flex">
              ...
              <Button asChild>
                <BookingButton to={booking}>{t.book}</BookingButton>
              </Button>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-5 py-10 lg:px-8 lg:py-12">
            ...
            <div className="footer-bottom mt-8 flex flex-col gap-2 border-t border-border/70 pt-5 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
              ...
              <p className="flex flex-wrap gap-x-4 gap-y-1">
                ...
                <BookingButton to={booking} className="font-semibold text-primary">
                  {t.bookDirect}
                </BookingButton>
