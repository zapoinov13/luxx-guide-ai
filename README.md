...
- Площадь номеров и цены прямого бронирования, если они отличаются от базовых (цены в сутки
  по пяти тарифам заказчик прислал в сентябре 2026, они в `ROOM_TYPES[].variants`).
- Ссылка на Instagram и карточку Google Maps, реквизиты от заказчика для `sameAs`.
